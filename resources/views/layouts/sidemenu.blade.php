<aside class="main-sidebar sidebar-dark-primary elevation-4">
 ...
 <!--      <div class="form-inline">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('admin.view.banner')}}" class="nav-link" id="carousalid">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.notifications.index') }}" id="marq" class="nav-link">
            <i class="far fa-circle nav-icon"></i>
              <p>
                Notification
          ...
          <li class="nav-item">
            <a href="{{route('admin.reviews.index')}}" id="test" class="nav-link">
            <i class="far fa-circle nav-icon"></i>
              <p>
                Review
 ...
 -->              </p>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
           <li class="nav-item">
            <a href="{{route('admin.treatments.index')}}" id="treatid" class="nav-link">
            <i class="far fa-circle nav-icon"></i>
              <p>
                Treatment
                <!-- <i class="right fas fa-angle-left"></i>
