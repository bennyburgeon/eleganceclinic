		...
		<div class="section bg-grey py-0">
			<div class="container-fluid px-0">
				<div class="row no-gutters">
					<div class="col-xl-6 banner-left bg-fullheight" style="background-image: url({{asset('web/images/content/banner-left10.jpg')}})"></div>
					<div class="col-xl-6">
							...
							<div id="tab-content" class="tab-content mt-sm-2">
								<div id="tab-A" class="tab-pane fade show active" role="tabpanel">
									<div id="faqAccordion1" class="faq-accordion" data-children=".faq-item">
										<div class="faq-item">
											<a data-toggle="collapse" data-parent="#faqAccordion1" href="#faqItem1" aria-expanded="false"><span>1.</span><span>Terms & Conditions</span></a>
											<div id="faqItem1" class="collapse hide faq-item-content" role="tabpanel">
												<div>
													...
													<p style="text-align: justify;"><strong>Cancellations</strong><br />Customers are required to provide 24 hours notice to reschedule or cancel all appointments.
										</br></br>
										All appointment slots at Elegance are in high demand. Failing to provide us with sufficient notice less than 24 hours, will result in your appointment being charged fully.
										</br></br>
										Deposits are required for all treatments booked at Elegance salons. Customers are required to provide us with 24 hours notice to reschedule or cancel their appointments. Failing to provide us with sufficient notice will result in 50% of the appointment being charged.
										</br></br>
										Any deposit paid towards your appointment will be non-refundable if cancellations are made under 24 hours notice.
										</br></br>
										In line with Elegance patch test policy, we ask that all customers understand and confirm the patch test requirements when booking with us online. If bookings made online are not compliant with our patch test policy, unfortunately your appointment will be charged fully as our appointment slots are in high demand. You will be given the opportunity to undertake a patch test and your appointment will be honoured at no extra charge for the one time as a gesture of goodwill.
										</p>
													...
													<p style="text-align: justify;"><strong>Patch Testing</strong><br />We prioritise customers’ safety over anything. Therefore, we have made ‘patch test’ a mandatory requirement, 48 hours prior to Eyebrow / Eyelash Tinting, Russian Lashes, Hi-Definition Brows, Lash Extensions, Lash Lift, and Hair Tint treatments.</br></br>
													If you haven’t done patch test with us before, or you don’t have any service history in our system for the above-mentioned treatments within last 6 months or if you have had any changes in your medical history since you last undergone the mentioned treatments, you are required to do a patch test.</br></br>If you don’t meet these conditions, we won’t be able to proceed with the treatments for your own safety.</p>
										...
										<div class="faq-item">
											<a data-toggle="collapse" data-parent="#faqAccordion1" href="#faqItem2" aria-expanded="false" class="collapsed"><span>2.</span><span>Privacy Policy</span></a>
										...
										<div class="faq-item">
											<a data-toggle="collapse" data-parent="#faqAccordion1" href="#faqItem3" aria-expanded="false" class="collapsed"><span>3.</span><span>Cookies Policy</span></a>
										...
										<div class="faq-item">
											<a data-toggle="collapse" data-parent="#faqAccordion1" href="#faqItem4" aria-expanded="false" class="collapsed"><span>4.</span><span>Delivery Information</span></a>
