		...
		<div class="section bg-grey py-0">
			<div class="container-fluid px-0">
				<div class="row no-gutters">
					<div class="col-xl-6 banner-left bg-fullheight" style="background-image: url({{asset('web/images/content/banner-left2.jpg')}})"></div>
					<div class="col-xl-6">
							...
							<div id="tab-content" class="tab-content mt-sm-2">
								<div id="tab-A" class="tab-pane fade show active" role="tabpanel">
									<div id="faqAccordion1" class="faq-accordion" data-children=".faq-item">
										<div class="faq-item">
											<a data-toggle="collapse" data-parent="#faqAccordion1" href="#faqItem2" aria-expanded="false" class="collapsed"><span>1.</span><span>Privacy Policy</span></a>
											<div id="faqItem2" class="collapse hide faq-item-content" role="tabpanel">
												<div>
										...
										<div class="faq-item">
											<a data-toggle="collapse" data-parent="#faqAccordion1" href="#faqItem1" aria-expanded="false"><span>2.</span><span>Terms & Conditions</span></a>
